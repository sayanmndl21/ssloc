...
#os.chdir('/home/sayan/duke_internship/acoustic_classification/soundfiles') # change to the file directory
	...
	#with open(root+'.csv', 'w',newline='') as f:
		for file in files:
			...
			for t in range(0,int(playlist_length),1):
				...
				newAudio.export(root+'/output/'+file[:-4]+str(int(t/1))+'.wav', format="wav")
